...
const VegetablesUpdate = () => {
  ...
  async function handleVegetablesGetId() {
    const res = await instance.get(`/newApi/${id}`);
    return res.data;
  }

  async function handleUpdateVegetables({ id, ...updatedData }) {
  ...
  const { data, error, isLoading } = useQuery({
    queryKey: ["getVegetablesId", id],
    queryFn: handleVegetablesGetId,
  });
...
export default VegetablesUpdate;
